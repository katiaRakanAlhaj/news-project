        ...
        {items?.map((item) => (
          <div className="flex gap-x-[1rem]">
            ...
            <div className="flex flex-col space-y-2 mt-[1rem]">
              <h1 className="text-secondary font-bold text-md">
                {item?.title}
              </h1>
              <p className="text-[#666666] text-sm leading-relaxed line-clamp-5">
                {item.description}
              </p>
              <img
                src={item.image}
                className="w-full h-[16rem] rounded-md object-cover"
              />
            </div>
          </div>
        ))}
