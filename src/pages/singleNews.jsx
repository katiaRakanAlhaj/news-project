...
// import SingleNewsModelOne from "../features/singleNews/component/singleNewsModelOne";
...
//       case 1: return <SingleNewsModelOne data={item} />;
...
//         {!isContentsEmpty &&
//           singleNewsData?.news_contents?.map((item, index) => {
//             if (item.model_id !== 5 && item.model_id !== 15 && item.model_id !== 16 && item.model_id = 1) {
//               return <div key={index}>{renderModel(item)}</div>;
//             }
//             return null;
//           })}
...
import i18next from "i18next";
import SingleNewsModelOne from "../features/singleNews/component/singleNewsModelOne";
import SingleNewsModelTwo from "../features/singleNews/component/singleNewsModelTwo";
import SingleNewsModelThree from "../features/singleNews/component/singleNewsModelThree";
import SingleNewsModelFour from "../features/singleNews/component/singleNewsModelFour"
import SingleNewsModelSix from "../features/singleNews/component/singleNewsModelSix";
import SingleNewsModelNine from "../features/singleNews/component/singleNewsModelNine";
...
const SingleNews = () => {
  ...
  const renderModel = (item) => {
    switch (item.model_id) {
      // case 1:
      //   return <SingleNewsModelOne data={item} />;
      // case 2:
      //   return <SingleNewsModelTwo data={item} />;
      // case 3:
      //   return <SingleNewsModelThree data={item} />;
        //  case 4:
        // return <SingleNewsModelFour data={item} />;
      // case 5:
      //   return <SingleNewsModel5 data={item} />;
        //    case 6:
        // return <SingleNewsModelSix data={item} />;
      // case 7:
      //   return <SingleNewsModel7 data={item} />;
      // case 8:
      //   return <SingleNewsModel8 data={item} />;
        //     case 9:
        // return <SingleNewsModelNine data={item} />;
        ...
        <div className="grid lg:grid-cols-12 grid-cols-1 gap-x-[1.5rem]">
          ...
          <div className="lg:col-span-8 col-span-1 mt-[2rem]">
            {isContentsEmpty ? (
              ...
              singleNewsData?.news_contents?.map((item, index) => (
                <div className = "flex flex-col space-y-[2rem]" key={index}>{renderModel(item)}</div>
              ))
            )}
          </div>
